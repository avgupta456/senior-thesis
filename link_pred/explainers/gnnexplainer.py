...
class GNNExplainer(Explainer):
    ...
    def explain_edge(self, node_idx_1, node_idx_2):
        edge_mask = self.explainer.explain_edge(node_idx_1, node_idx_2, self.x, self.edge_index)

        output = {}
        edge_filter = (self.edge_index[1] == node_idx_1) | (self.edge_index[1] == node_idx_2)
